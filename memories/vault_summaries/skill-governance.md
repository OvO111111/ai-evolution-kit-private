...
- `%USERPROFILE%\.codex\skills`: 35 `SKILL.md` files
- `%USERPROFILE%\.agents\skills`: 26 `SKILL.md` files
...
`%USERPROFILE%\.codex\private\knowledge-vault\config\skill-portfolio.jsonl`
...
`%USERPROFILE%\.codex\private\knowledge-vault\config\skill-trigger-tests.jsonl`

Created a checker:

`%USERPROFILE%\.codex\private\knowledge-vault\scripts\check_skill_routing.py`
