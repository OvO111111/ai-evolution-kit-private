...
4. Check `%USERPROFILE%\.codex\memories\MEMORY.md` for rollout-specific references.
...
```powershell
rg -n "<keyword>" %USERPROFILE%\.codex\private\knowledge-vault %USERPROFILE%\.codex\memories\MEMORY.md
```
