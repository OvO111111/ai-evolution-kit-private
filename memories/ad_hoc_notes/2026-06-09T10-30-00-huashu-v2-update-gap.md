...
- Synced local `%USERPROFILE%\.codex\skills\huashu-design` resources from upstream `v2.0`.
...
- Reran `%USERPROFILE%\.codex\design-skill-smoke\run-design-routing-smoke.ps1`; result passed with `skill_lane_count: 4`.
