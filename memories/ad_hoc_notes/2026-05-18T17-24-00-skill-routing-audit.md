...
Global routing was tightened in `%USERPROFILE%\.codex\AGENTS.md`:
...
Implemented change: rewrote the global `Skill Routing And Evolution` section in `%USERPROFILE%\.codex\AGENTS.md` to remove concrete skill-name routing and replace it with this boundary model.
