...
3. **Find Local Sources**
   - Search the current workspace and private registered project roots first. Exact
     local root paths belong in private configuration, not this portable skill.
   ...
   - Search near known project folders before scanning broad private project roots.
