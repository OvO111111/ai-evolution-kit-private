---
name: pptx
description: "Legacy fallback for Microsoft PowerPoint `.pptx` inspection or repair when the official `Presentations` skill is unavailable, fails setup, or the task explicitly needs low-level PPTX/OOXML surgery."
---
