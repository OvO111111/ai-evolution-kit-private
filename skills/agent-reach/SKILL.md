---
name: agent-reach
description: "Research and read public web, social, video, code, RSS, and article sources through available web tools and platform-specific command patterns, with explicit safety limits for account actions."
---

## Codex Safety Override

Use this skill for discovery, search, and reading by default. Do not request, store, or import browser cookies, tokens, passwords, or account secrets. Do not post, comment, publish, follow, like, or modify any external account unless the user explicitly asks for that exact action in the current turn and the action is legally and ethically appropriate. Prefer the built-in web/browser tools available in Codex before installing or configuring external platform tools.
