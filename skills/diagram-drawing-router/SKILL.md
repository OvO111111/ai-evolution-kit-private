...
- Resolve the user's default whiteboard document from private configuration when no target is specified. Never store its document or board token in the portable skill.
