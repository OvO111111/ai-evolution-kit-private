...
description: Fallback image-first website workflow for landing pages, marketing sites, portfolios, and editorial brand pages when the official Product Design `image-to-code` workflow is unavailable or the user explicitly asks for this legacy image-first method. Do not use for admin/internal tools, ordinary implementation, or when Product Design has a selected visual target and is callable.
---
