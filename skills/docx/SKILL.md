---
name: docx
description: "Legacy fallback for Microsoft Word `.docx` inspection or repair when the official `documents` skill is unavailable, fails setup, or the task explicitly needs low-level OOXML surgery."
---
